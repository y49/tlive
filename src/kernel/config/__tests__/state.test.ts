...
describe('daemon state', () => {
  ...
  // between those two steps used to leave a 0-byte state.json, silently
  // dropping whatever notifyExplainedChats entries were on disk.
  describe('atomic writes (I3)', () => {
    it('sequential writes accumulate without one clobbering another', () => {
      markNotifyExplained(home, 'telegram:1');
