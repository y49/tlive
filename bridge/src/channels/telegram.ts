  ...
  async start(): Promise<void> {
    ...
    try {
      ...
      await this.bot.api.setMyCommands([
        ...
        { command: 'stop', description: 'Interrupt current execution' },
        ...
        { command: 'perm', description: 'Claude: permission prompts on/off' },
        { command: 'mode', description: 'Codex: permission mode preset' },
