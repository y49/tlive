...
describe('v2 CLI surface', () => {
  it('is exactly the 8 core subcommands + `mode` (posture: off/notify/full, persisted to config) + the 4 runtime toggles (mute/trust/safe/desktop — same setters as the IM commands)', () => {
